...
def readcase_thrulines(log, all_data, lines):
    ...
    logpcasename  = 'perturbedcases_logs/' + all_data['casename'] + '_b.log' #here we keep track of perturbations
    #logpcasename  = 'perturbedcases_logs/' + all_data['casename'] + '_n_0_5.log' #here we keep track of perturbations
    #logpcasename  = 'perturbedcases_logs/' + all_data['casename'] + '_n_5_5.log' #here we keep track of perturbations
